...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (24 * 1024)   /*[bytes] was 24 *1024 */
...
#define LV_USE_CALENDAR   1
    ...
    #define LV_CALENDAR_DEFAULT_MONTH_NAMES {"Jan.", "Feb.", "Mar.",  "Apr.", "May",  "June", "July", "Aug.", "Sept.", "Oct.", "Nov.", "Dec."}
